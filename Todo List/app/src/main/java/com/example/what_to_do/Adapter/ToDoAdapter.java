...
import com.example.what_to_do.AddNewTask;
import com.example.what_to_do.MainActivity;
...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.ViewHolder> {
    private List<ToDoModel> mainToDoList;
    ...
    public void onBindViewHolder(ViewHolder holder, int position){
        db.openDatabase();
        ToDoModel item=mainToDoList.get(position);
    ...
    public int getItemCount(){
        return mainToDoList.size();
    }
    private boolean toBoolean(int n){
        return n!=0;
    }
    public void setTasks(List<ToDoModel> todoList){
        this.mainToDoList=todoList;
